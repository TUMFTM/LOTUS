...
results.reference       = load('Post-processing/JCP_EE/Results_EE/20210419_Reference.mat');
results.dieselResult    = load('Post-processing/JCP_EE/Results_EE/20210507_Diesel.mat');
results.hevResults      = load('Post-processing/JCP_EE/Results_EE/20210507_HEV.mat');
results.bevResult       = load('Post-processing/JCP_EE/Results_EE/20210507_BEV.mat');
results.fcevResult      = load('Post-processing/JCP_EE/Results_EE/20210507_FCEV.mat');
results.hiceResult      = load('Post-processing/JCP_EE/Results_EE/20210507_HICE.mat');
