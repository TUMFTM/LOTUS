...
%                         fprintf('Acquisition cost:  %2.4f EUR\n', Param.acquisitionCosts.KA_ZM );  %Output acquisition cost in �
    ...
    %                     Param.Bat.SOH = interp1([0 Param.TCO.Lebensdauerbatteriepack], [100 80], Param.TCO.Operating_life(1), 'linear', 'extrap');
                        Param.TCO.residualValueBattery(1,1) = (1+floor(Param.TCO.Operating_life(1)/Param.TCO.Lebensdauer_Batteriepack)) * Param.acquisitionCosts.Bat_kWh .* 25; % S. Rohr, S. Wagner, M. Baumann, S. M�ller, und M. Lienkamp, �A techno-economic analysis of end of life value chains for lithium-ion batteries from electric vehicles,� in 2017 Twelfth International Conference on Ecological Vehicles and Renewable Energies (EVER), 2017, S. 1�14.


                        if ~Param.VSim.Opt
    %                         fprintf('Verschleissdauer Batteriepack in:  %2.4f  Jahren \n', Param.TCO.Lebensdauerbatteriepack);
    %                         fprintf('ben�tigte Batteriepacks in:  %2.4f  St�ck \n', ((Param.TCO.Nutzungsdauer(1) / Param.TCO.Lebensdauerbatteriepack)) );
    ...
    %                         fprintf('ben�tigte Batteriepacks in:  %2.4f  St�ck \n', ((Param.TCO.Nutzungsdauer(1) / Param.TCO.Lebensdauerbatteriepack)) );
            ...
            if (Param.VSim.Display == 1 || Param.VSim.Display == 2)  && Param.VSim.Opt == 0
                ...
                if Param.Hybrid_Truck == 1
                    ...
                    % M�glichkeit, das Wirkungsgradkennfeld der E-Maschine in 3D zu
